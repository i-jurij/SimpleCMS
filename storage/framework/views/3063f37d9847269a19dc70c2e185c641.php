...
<?php if(!empty($menu)): ?> <p class="content"><?php echo e($menu); ?></p> <?php endif; ?>
    ...
    <?php else: ?>
        ...
        <div class="back shad rad pad margin_bottom_1rem form_recall_div">
            <form action="<?php echo e($action); ?>" method="post" class="form-recall-main" id="recall_one">
                <?php echo csrf_field(); ?>
                <div class="">
                    <div class="form-group padt1">
                        <div class="">
                            ...
                            <label class="zapis_usluga">Ваше имя:
                                <br>
                                <input type="text" placeholder="Не обязательно заполнять" name="name" id="name" maxlength="255" value="<?php echo e(old('name')); ?>" />
                            </label>
                            <br>
                            ...
                            <label class="zapis_usluga">Вопрос:
                                <br>
                                <textarea placeholder="Не обязательно заполнять" name="send"  id="send" maxlength="500" value="<?php echo e(old('send')); ?>"></textarea>
                            </label>
                        </div>
                    </div>
                ...
                <div class="margin_top_1rem">
                    ...
                    <br>
                    <a href="<?php echo e(url('/persinfo')); ?>">
        ...
        function ajax_mail() {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo e(url()->route("client.callback.send_mail")); ?>',
                method: 'post',
                dataType: 'json',
                data: dataar,
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            $(function() {
                ...
                if (imgs.length > 0) {
                    ...
                    {
                        let imgpath = '<?php echo e(asset("storage")); ?>';
                    ...
                    // laravel captcha
                    $('#sr_but').before('<div class="form-group<?php echo e($errors->has("captcha") ? " has-error" : ""); ?> margin_bottom_1rem">\
                            <p id=\"mes\"></p>\
                            <div>\
                                <div class=\"capcha2\">\
                                    <span class=\"display_inline_block div_center\" style=\"vertical-align: middle;\"><?php echo captcha_img(); ?></span>\
                    ...
                    $('#reload').click(function () {
                        $.ajax({
                            type: 'GET',
                            url: '<?php echo e(url()->route("captcha.reload")); ?>',
                            success: function (data) {
...
<?php echo $__env->make("layouts/index", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/client_manikur/client_pages/callback.blade.php ENDPATH**/ ?>