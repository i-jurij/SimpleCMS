...
<style>
    ...
    <?php if(!empty($data['res'])): ?>
        <div class="content">
            <?php if(is_array($data['res'])): ?>
                <?php $__currentLoopData = $data['res']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $res): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php echo e($res); ?><br>
    ...
    <?php else: ?>
        ...
        <div class="content">
        <form action="<?php echo e(url()->route('admin.signup.settings.store')); ?>" method="post" id="signup_settings_form" class="div_center" style="max-width: 80rem;">
        <?php echo csrf_field(); ?>
            <table class="table" >
                <colgroup>
                    <col width="45%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="td text_left" >
                            ...
                            <?php $__currentLoopData = $days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label >
                                    <input type="checkbox" name="weekend[<?php echo e($key); ?>]" value="<?php echo e($day); ?>" />
                                    <?php echo e($day); ?>

                                </label>
                                <input type="time" name="weekend_start[<?php echo e($key); ?>]" value="" title="Weekend start time">
                                <br>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="td text_left" >
                            <input type="text" id="datepicker" name="dpholidays" value="<?php echo e(date('Y')); ?>"/>
                        </td>
                    </tr>
                </tbody>
            </table>
...
<?php echo $__env->make("layouts/index_admin", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin_manikur/moder_pages/signup_settings.blade.php ENDPATH**/ ?>