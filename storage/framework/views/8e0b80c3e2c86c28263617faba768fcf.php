...
<div class="content main">
    <?php if(!empty(session('res'))): ?>
        <?php if(is_array(session('res'))): ?>
            <?php $__currentLoopData = session('res'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php echo e($mes); ?><br>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php elseif(is_string(session('res'))): ?>
            <p class="pad"><?php echo e(session('res')); ?></p>
        <?php endif; ?>
    <?php endif; ?>
    <?php if(!empty($list) && is_array($list)): ?>
        <form action="<?php echo e(url()->route('admin.logs.show')); ?>" method="post" enctype="application/x-www-form-urlencoded" id="" class="form_radio_btn">
        <?php echo csrf_field(); ?>
            ...
            <label >
                <input type="radio" name="log_name" value="<?php echo e($value['file']); ?>" />
                <span><?php echo e(Crypt::decryptString($value['file'])); ?><br><?php echo e($value['size']); ?></span>
            </label>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <p class="pad">
...
<?php echo $__env->make("layouts/index_admin", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin_manikur/adm_pages/logs.blade.php ENDPATH**/ ?>