...
<div class="content">
    <?php if(!empty($res) && is_array($res) && !empty($res['master'])): ?>
    <form action="<?php echo e(url()->route('admin.masters.update')); ?>" method="post"  enctype="multipart/form-data" id="master_edit_form">
    <?php echo csrf_field(); ?>
        <div class="form-recall-main">
            ...
            <div class="">
                ...
                <div class="master_create">
                    ...
                    <input type="text" value="<?php echo e($res['master']['master_name']); ?>" placeholder="Name Имя" name="master_name" id="master_name" maxlength="30" required></input>
                    <br>
                    <input type="text" value="<?php echo e($res['master']['sec_name']); ?>" placeholder="Second name Отчество" name="sec_name" id="sec_name" maxlength="30"></input>
                    <br>
                    <input type="text" value="<?php echo e($res['master']['master_fam']); ?>" placeholder="Last name Фамилия" name="master_fam" id="master_fam" maxlength="30" required></input>
                    <br>

                    <input type="tel" value="<?php echo e($res['master']['master_phone_number']); ?>" name="master_phone_number"  id="master_number" class="number" title="+7 999 999 99 99" minlength="6" maxlength="17"
                    ...
                    <div class="shoose_services pad mar">
                        ...
                        <ul>
                            <?php $__currentLoopData = $res['services']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    list($page_id, $page_title) = explode('#', $key);
                                ?>
                                <li class="display_inline_block text_left margin_top_1rem">
                                <label class=" buttons" for="p<?php echo e($page_id); ?>">
                                    <input type="checkbox" id="p<?php echo e($page_id); ?>" class="pagess"> <?php echo e($page_title); ?>: all все
                                </label>

                                <input type="button" class=" buttons clarify" id="add<?php echo e($page_id); ?>" value="Clarify Уточнить" />
                                    <ul class="display_none" id="padd<?php echo e($page_id); ?>">
                                        <?php $__currentLoopData = $service; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ke => $cats): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <li class="display_inline_block margin_top_1rem pad" style="position:relative; vertical-align:top;">
                                                <label class="buttons">
                                                    <input type="checkbox" class="pp<?php echo e($page_id); ?>" id="c<?php echo e($cat_id); ?>" > <?php echo e($cat_name); ?>
                    ...
                    <br>
                    <label>
                        <input type="date" name="hired" value="<?php echo e($res['master']['data_priema']); ?>" id="hired" min="2023-01-01" max="2050-12-31"></input>
                    </label>
                    <br>
                    ...
                    <br>
                    <label>
                        <input type="date"  value="<?php echo e($res['master']['data_uvoln']); ?>" name="dismissed" id="dismissed"  min="2023-01-01" max="2050-12-31"></input>
                    </label>
                </div>
            </div>

            <input type="hidden" name="id" value="<?php echo e($res['master']['id']); ?>" required />
...
<?php echo $__env->make('layouts/index_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin_manikur/moder_pages/masters_edit.blade.php ENDPATH**/ ?>