...
<div class=" ">
<?php if(!empty($img_res)): ?> <p class="content">MESSAGE: <?php echo $img_res; ?></p> <?php endif; ?>
    <div class="margin_bottom_1rem" style="max-width:55rem;">
                <form action="<?php echo e(url()->route('admin.pages.store')); ?>" method="post" enctype="multipart/form-data" name="create_page" id="create_page" class="form_page_add">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts/index_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin_manikur/moder_pages/pages_create_form.blade.php ENDPATH**/ ?>